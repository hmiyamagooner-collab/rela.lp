...
(function () {
  var PAYMENT_LINKS = {
    basic: 'https://buy.stripe.com/REPLACE_BASIC', // RELA ベーシック ¥500/月
    standard: 'https://buy.stripe.com/REPLACE_STANDARD', // RELA スタンダード ¥1,500/月(3日トライアル)
    premium: 'https://buy.stripe.com/REPLACE_PREMIUM', // RELA プレミアム ¥3,800/月
    coin180: 'https://buy.stripe.com/REPLACE_COIN180', // RELA 180コイン ¥300(都度)
  };
